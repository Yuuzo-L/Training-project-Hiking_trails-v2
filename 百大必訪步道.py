...
url = 'https://hiking.biji.co/index.php?q=trail&type=%E7%99%BE%E5%A4%A7%E5%BF%85%E8%A8%AA%E6%AD%A5%E9%81%93&filter=1&page='
...
df.to_csv("Top100_list.csv",index =False, encoding="utf-8")
print('已存到 Top100_list.csv')